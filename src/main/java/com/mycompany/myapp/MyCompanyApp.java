...
public class MyCompanyApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(MyCompanyApp.class);

    private final Environment env;

    public MyCompanyApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MyCompany.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MyCompanyApp.class);
